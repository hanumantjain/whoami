...
const Contact = () => {
  ...
  return (
    <div
      ...
      className="w-full max-w-6xl mx-auto text-center p-10"
    >
      <h2 className="text-5xl text-center mb-20 font-bold">Contact</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
        <div data-aos="fade-up" className="border rounded-2xl p-10 shadow-lg border-neutral-800 hover:shadow-2xl transition-shadow duration-300 ease-in-out">
